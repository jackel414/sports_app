...
if patriots_game
  ...
  if game_status.match(/PM|AM/)
    $patriots_message = 'The Patriots game hasn\'t started yet.'
    $patriots_outcome = 'later'
    ...
    $patriots_message = 'The game is in progress.'
    $patriots_outcome = 'pending'
  end
else
  $patriots_message = 'The Patiots don\'t play today.'
end

if $patriots_outcome == 'later'
  $patriots_message = "The Patriots play at #{game_status}."
elsif $patriots_outcome == 'pending'
  $patriots_message = "#{message} #{patriots_game} - #{game_status}"
else
end
