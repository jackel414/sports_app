...
if celtics_game
  ...
  if game_status.match(/PM|AM/)
    $celtics_message = 'The Celtics game hasn\'t started yet.'
    $celtics_outcome = 'later'
    ...
    $celtics_message = 'The game is in progress.'
...
if $celtics_outcome == 'later'
  $celtics_message = "The Celtics play at #{game_status}."
elsif $celtics_outcome == 'pending'
  $celtics_message = "#{message} #{celtics_game} - #{game_status}"
else
end
